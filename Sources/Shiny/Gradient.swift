...
public extension Gradient {
    ...
    static var iridescent: Gradient {
        Gradient(colors: [
            Color(red: 142 / 255, green: 157 / 255, blue: 237 / 255), // Light purple (darkest)
            Color(red: 170 / 255, green: 175 / 255, blue: 240 / 255), // Softer purple
            Color(red: 192 / 255, green: 192 / 255, blue: 192 / 255), // Silver
            Color(red: 224 / 255, green: 224 / 255, blue: 224 / 255), // Light silver
            Color(red: 255 / 255, green: 255 / 255, blue: 255 / 255)  // White (lightest)
        ])
    }
